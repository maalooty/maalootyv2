...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'maalooty;Skl11;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/G9sqHBqTMBJ2nazQdZNPo2',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA||"maalooty",
    BOT_NAME: process.env.BOT_NAME || 'maalooty',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'LFA HERMIT;maalooty bot;https://www.linkpicture.com/q/rgnk.jpg' : process.env.AUDIO_DATA,
